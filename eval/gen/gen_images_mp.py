...
###
    ...
    # Build empty Bagel with meta weights
    ...
    # Keep certain modules on same GPU (optional)
    same_device_modules = [
    ...
    model = model.eval()
    vae_model = vae_model.to(device_map.get("vae_model", "cuda:0"), dtype=torch.bfloat16).eval()
